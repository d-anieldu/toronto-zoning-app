...
const ALL_EXAMPLE_ADDRESSES = [
  ...
  "1 Austin Terrace",
  "181 Dundas St E",
  "2130 Morningside Ave",
  "1 Palace Pier Ct",
  "51 Thorncliffe Park Dr",
  "715 Don Mills Rd",
  "900 Mount Pleasant Rd",
  "6 Glamis Rd",
  "15 Rockwell Ave",
  "80 Gerrard St E",
  "180 Steeles Ave W",
  ...
  async function handleSubmit(e?: React.FormEvent, overrideAddress?: string) {
    ...
    try {
      const res = await fetch("/api/lookup", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ address: lookupAddr.trim(), include_parcel: true, include_nearby: false, include_policy: true }),
      });
